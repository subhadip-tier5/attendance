function HangoutCountDown(settings) {
    var glob = settings;
    ...
    var clock = {
        set: {
            days: function(){
                ...
                ctx.arc(45,45,35, deg(0), deg((360/glob.total)*(glob.total - glob.days)));
                ctx.lineWidth = 5;
                ctx.stroke();
            ...
            hours: function(){
                ...
                ctx.arc(45,45,35, deg(0), deg(15*glob.hours));
                ctx.lineWidth = 5;
                ctx.stroke();
            ...
            minutes : function(){
                ...
                ctx.arc(45,45,35, deg(0), deg(6*glob.minutes));
                ctx.lineWidth = 5;
                ctx.stroke();
            ...
            seconds: function(){
                ...
                ctx.arc(45,45,35, deg(0), deg(6*glob.seconds));
                ctx.lineWidth = 5;
                ctx.stroke();
